...
ADDRESS_CHAIN_PREFIX_DICT: Dict[Chain, bytes] = {
    Chain.MAIN: b'\x00',
    Chain.TEST: b'\x6f',
}
...
WIF_CHAIN_PREFIX_DICT: Dict[Chain, bytes] = {
    Chain.MAIN: b'\x80',
    Chain.TEST: b'\xef',
}
...
NUMBER_BIT_LENGTH: int = 32

PUBLIC_KEY_COMPRESSED_PREFIX_EVEN_Y: bytes = b'\x02'
PUBLIC_KEY_COMPRESSED_PREFIX_ODD_Y: bytes = b'\x03'
PUBLIC_KEY_COMPRESSED_PREFIX_LIST: List[bytes] = [PUBLIC_KEY_COMPRESSED_PREFIX_EVEN_Y, PUBLIC_KEY_COMPRESSED_PREFIX_ODD_Y]
PUBLIC_KEY_COMPRESSED_EVEN_Y_PREFIX_DICT: Dict[bool, bytes] = {
    True: PUBLIC_KEY_COMPRESSED_PREFIX_EVEN_Y,
    False: PUBLIC_KEY_COMPRESSED_PREFIX_ODD_Y,
}
